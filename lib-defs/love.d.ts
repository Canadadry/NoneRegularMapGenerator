...
declare interface Joystick extends Object {
  ...
  getGamepadMapping(
    axis: GamepadAxis
  ): [JoystickInputType, number, JoystickHat];
   ...
   * @return {boolean} anyDown, True if any supplied button is down, false if not.
   */
  isGamepadDown(...vararg: LoveGamepadButton[]): boolean;
...
Note that you can't disable love.filesystem; it's mandatory. The same goes for the love module itself. love.graphics needs love.window to be enabled.
   ...
   */
  export let gamepadpressed: (
    joystick: Joystick,
    button: LoveGamepadButton
  ) => void;
  ...
  export namespace event {
     ...
     *
     * @return {LoveEvent} e, The type of event.
     ...
     */
    /** !TupleReturn */
    export function wait(): [LoveEvent, Variant, Variant, Variant, Variant];
  }
  /**
  ...
  export namespace graphics {
     ...
     */
    export function newParticleSystem(
      texture: Texture,
      buffer?: number
    ): ParticleSystem;
     ...
     */
    export function newSpriteBatch(
      texture: Texture,
      maxsprites?: number,
      usage?: SpriteBatchUsage
    ): SpriteBatch;
     ...
     */
    export function setStencilTest(
      comparemode: CompareMode,
      comparevalue: number
    ): void;
  ...
  export namespace keyboard {
     ...
     */
    export function isScancodeDown(
      scancode: Scancode,
      ...vararg: Scancode[]
    ): boolean;
  ...
  export namespace physics {
     ...
     * @return {CircleShape} shape, The new shape.
     */
    export function newCircleShape(
      x: number,
      y: number,
      radius: number
    ): CircleShape;
